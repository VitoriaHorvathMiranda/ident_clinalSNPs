...
O Pacote qvalue também faz o histograma dos p-valores, que para esse teste de 97 está [aqui](https://github.com/VitoriaHorvathMiranda/ident_clinalSNPs/blob/main/hist_97.png)

Eu só fiz esse último passo para os SNPs de 1997, porque ainda estava testando o script e ainda não tentei rodar ele com o Snakemake.
