...
Extraí as frequências e a profundidade de leitura de cada SNP, com o script [freq_extraction.R](). 
...
Para identificar os SNPs clinais era preciso correr um GLM para cada SNP de cada período. Usei o mesmo GLM escolhido pelo Murillo, mas talvez isso possa ser debatido. É um modelo com a frequência dos SNPs como variável preditora e a latitude como variável resposta, com função de ligação binomial e pesado para o número efetivo de cromossomos [glm_script.R]()  
